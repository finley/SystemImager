...
variable is used by I<getimage> and I<mksimachine> to determine where
to put the created image.
...
I<mkautoinstallscript> to determine where the autoinstall script for
an image should be created.  It is also used by I<addclients>, and
I<mksimachine>, and I<mksirange> to determine where the client scripts
should be created.
...
I<mkautoinstallcd>, I<mkautoinstalldiskette> and I<mkbootserver>.

=item B<RSYNCD_CONF>

The local of the I<rsyncd.conf> file associated with SystemImager.
The installed default is I</etc/systemimager/rsyncd.conf>.
